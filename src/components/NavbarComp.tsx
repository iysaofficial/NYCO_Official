    ...
    return(
        ...
        <header>
            <Link href="/">
                <Image 
                    className='logo-nav' 
                    src="/assets/images/logo/NYCO.png" 
                    alt="IYCO Logo" 
                    width={100} 
                    height={50}
                    priority
            ...
            <div className='navigation'>
                <ul className='menu'>
                    ...
                    <li className='menu-item'>
                        ...
                        <ul className='sub-menu'>
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1AZGvuSArCKoi2UNDnYA2wzJ__NxCSLh3?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1crpDFnkh5xnEFzuuZWmq6-jFJX4yKOwi?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1V7TbeRwt4Rat2rOZckZoOZYZWvpRf51r?usp=sharing" 
                                    target='_blank'
                                    rel="noopener noreferrer">
                    ...
                    <li className='menu-item'>
                        <Link className='sub-btn' href="#">Galeri <i className='fas fa-angle-down'></i></Link>
                        <ul className='sub-menu'>
                            <li className='sub-item'>
