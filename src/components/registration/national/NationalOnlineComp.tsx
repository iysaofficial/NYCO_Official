...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">NYCO 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HALLO PESERTA NYCO 2026, Mohon perhatikan informasi berikut ini sebelum mengisi formulir pendaftaran:
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">Sumber Informasi Kompetisi NYCO 2026</label>
        <select name="SUMBER_INFORMASI" className="select-field" required>
          <option value="">--Pilih Sumber Informasi--</option>
          <option value="IYSA Instagram">IYSA Instagram</option>
          <option value="NYCO Instagram">NYCO Instagram</option>
          <option value="Pembimbing/Sekolah">Pembimbing/Sekolah</option>
          <option value="IYSA FaceBook">IYSA FaceBook</option>
          <option value="IYSA Linkedin">IYSA Linkedin</option>
          <option value="IYSA Website">IYSA Website</option>
          <option value="NYCO Website">NYCO Website</option>
          <option value="IYSA Email">IYSA Email</option>
          <option value="NYCO Email">NYCO Email</option>
